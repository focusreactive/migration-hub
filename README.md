...
Three assessments generated by this repository — the full HTML report, plus the same report in markdown.

| Site | Live report | Markdown |
| --- | --- | --- |
| [nova-x.webflow.io](https://nova-x.webflow.io/) | [open](https://migration-report-examples.vercel.app/reports/nova-x-webflow-io) | [read](report-examples/nova-x-webflow-io.md) |
| [rythm-path-five.webflow.io](https://rythm-path-five.webflow.io/) | [open](https://migration-report-examples.vercel.app/reports/rythm-path-five-webflow-io) | [read](report-examples/rythm-path-five-webflow-io.md) |
| [pixwave.framer.website](https://pixwave.framer.website/) | [open](https://migration-report-examples.vercel.app/reports/pixwave-framer-website) | [read](report-examples/pixwave-framer-website.md) |
